...
let handler = async(m, { conn, text }) => {
   ...
   for (let id of chats) await conn.copyNForward(id, conn.cMod(m.chat, cc, /bc|broadcast|tx/i.test(teks) ? teks : `https://github.com/jayden-official *𓆈BROADCAST ┃ANONYMOUS𓆈*\n_____________________\n ${teks} ` ), true).catch(_ => _)
