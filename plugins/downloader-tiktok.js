...
const handler = async (m, {conn, text, args, usedPrefix, command}) => {
  ...
  try {
    ...
    const prep = generateWAMessageFromContent(m.chat, {extendedTextMessage: {text: texto, contextInfo: {externalAdReply: {title: '*THE ANONYMOUS-BOT*', body: null, thumbnail: imagen1, sourceUrl: 'https://github.com/jayden-official'}, mentionedJid: [m.sender]}}}, aa);
