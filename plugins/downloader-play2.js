...
if (enviando) return;
  ...
  try {
    ...
    if (!data.resultado || !data.resultado.url) {
      enviando = false;
      throw `https://github.com/jayden-official _*< ANONYMOUS - PLAY v2 />*_\n\n*[ ❗ ] An error occurred. Please try again later.*`;
    } else {
      try {      
